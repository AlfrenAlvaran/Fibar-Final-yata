										...
										<thead>
											<tr>
												<th class="cart-remove item"
													style="font-size: 1.5rem; font-weight: bold; color: black; text-align: left; padding: 10px; background-color: #f8f8f8; border-bottom: 2px solid #ddd;">
													Remove
												</th>

												<th class="cart-description item"
													style="font-size: 1.5rem; font-weight: bold; color: black; text-align: center; padding: 10px; background-color: #f8f8f8; border-bottom: 2px solid #ddd;">
													Image
												</th>
												...
												<th class="cart-quantity-name item"
													style="font-size: 1.5rem; font-weight: bold; color: black; text-align: center; padding: 10px; background-color: #f8f8f8; border-bottom: 2px solid #ddd;">
													Quantity
												</th>

												<th class="cart-sub-total-name item"
													style="font-size: 1.5rem; font-weight: bold; color: black; text-align: center; padding: 10px; background-color: #f8f8f8; border-bottom: 2px solid #ddd;">
													Price per unit
												</th>
													...
													<div class="shopping-cart-btn">
														<span class="">
															<a href="index.php" class="btn btn-upper btn-primary outer-left-xs"
																style="display: inline-block; font-size: 1.5rem; background-color: #007bff; color: white; padding: 10px 20px; border: none; border-radius: 5px; text-decoration: none; text-transform: uppercase; transition: background-color 0.3s;">Continue Shopping</a>
															<input type="submit" name="submit" value="Update shopping cart"
																class="btn btn-upper btn-primary pull-right outer-right-xs"
																style="font-size: 1.5rem; background-color: #007bff; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; text-transform: uppercase; transition: background-color 0.3s;"> </span>
								...
								<tr>
									<th>
										<span class="estimate-title"
											style="font-size: 1.5rem; font-weight: bold; color: black; text-decoration: underline; margin-bottom: 10px;">
											Shipping Address
										</span>
									</th>
								</tr>
											...
											?>
												...
												<div class="form-group">
													<label class="info-title" for="Billing Address"
														style="font-size: 1.2rem; font-weight: bold; color: #333; display: block; margin-bottom: 5px;">
														Billing Address<span style="color: red;">*</span>
														<textarea class="form-control unicase-form-control text-input"
															name="billingaddress"
															required="required"
															style="width: 100%; height: 100px; padding: 10px; border: 1px solid #ccc; border-radius: 4px; font-size: 1rem; color: #333; resize: vertical;">
    <?php echo $row['billingAddress']; ?>
</textarea>
												</div>
									...
									<td>
										<div class="cart-checkout-btn pull-right">
											<button type="submit" name="ordersubmit"
												...
												style="font-size: 1.5rem; background-color: #007bff; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; text-transform: uppercase; transition: background-color 0.3s;">
												PROCEED TO CHECKOUT
											</button>
										</div>
									</td>
