...
<body class="cnt-home">
    ...
    if ($num > 0) {
        while ($row = mysqli_fetch_array($ret)) { ?>
            <div class="col-sm-6 col-md-3 wow fadeInUp" style="padding: 15px;">
                <div class="products">
                    <div class="product">
                        <div class="product-image">
                            <div class="image">
                                <a href="product-details.php?pid=<?php echo htmlentities($row['id']); ?>">
                                    <img src="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage1']); ?>" alt="" style="width: 100%; height: auto;">
                                </a>
                            </div>
                        </div>
